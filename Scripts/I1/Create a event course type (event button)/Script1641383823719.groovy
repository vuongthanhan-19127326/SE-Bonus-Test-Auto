...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard/select_January        February        March_78ea2e'), 
    '12', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard/select_User            Group            Cou_43b121'), 
    'course', true)

WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/li_8'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Dashboard/select_86754312'), '9', true)
