...
WebUI.click(findTestObject('Object Repository/Page_4 Lesson 1 Edit/i_Next page_icon fa fa-search-plus fa-fw'))

WebUI.setText(findTestObject('Object Repository/Page_4 Lesson 1 Anh le la ai/div_1'), '<p dir="ltr" style="text-align: left;">1</p>')

WebUI.click(findTestObject('Object Repository/Page_4 Lesson 1 Anh le la ai/input_Rich text editor_submitbutton'))
