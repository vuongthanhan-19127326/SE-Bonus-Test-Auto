...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_4 Lesson 1 Edit/select_Add a new page.                    A_066c8c'), 
    '0', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_4 Lesson 1 Edit/select_Essay            Matching           _0874e8'), 
    '10', true)

WebUI.click(findTestObject('Object Repository/Page_4 Lesson 1 Edit/input_Select a question type_submitbutton'))

WebUI.setText(findTestObject('Object Repository/Page_4 Lesson 1 Edit/input_Page title_title'), 'Anh le la ai')

WebUI.setText(findTestObject('Object Repository/Page_4 Lesson 1 Edit/div_Anh le la ai'), '<p dir="ltr" style="text-align: left;">Anh le la ai</p>')

WebUI.scrollToElement(findTestObject('Object Repository/Page_4 Lesson 1 Edit/input_Select a question type_submitbutton'), 
    0)
