...
WebUI.click(findTestObject('Object Repository/Page_4 Lesson 1 Edit/i_Next page_icon fa fa-arrows-v fa-fw'))

WebUI.click(findTestObject('Object Repository/Page_4 Lesson 1 Moving page Anh le la ai/a_Move page to here'))
