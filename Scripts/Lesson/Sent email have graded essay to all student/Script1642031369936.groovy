...
WebUI.setText(findTestObject('Object Repository/Page_L Tm Anh Log in to the site/input_Username_username'), 'anhle6')
...
WebUI.click(findTestObject('Object Repository/Page_Course 5/a_Lesson 5'))

WebUI.click(findTestObject('Object Repository/Page_5 Lesson 5 1/button_Grade essays'))

WebUI.click(findTestObject('Object Repository/Page_5 Lesson 5 Grade essays/a_Email ALL graded essays'))
